...
-- CreateEnum
CREATE TYPE "IdentitySecurityEventType" AS ENUM ('IDENTITY_REGISTERED', 'EMAIL_VERIFICATION_REQUESTED', 'EMAIL_VERIFICATION_RESENT', 'EMAIL_VERIFIED', 'EMAIL_VERIFICATION_FAILED', 'EMAIL_VERIFICATION_EXPIRED', 'PASSWORD_CHANGED', 'PASSWORD_RESET_REQUESTED', 'PASSWORD_RESET_RESENT', 'PASSWORD_RESET_COMPLETED', 'PASSWORD_RESET_FAILED', 'PASSWORD_RESET_EXPIRED', 'PASSWORD_CREDENTIAL_REPLACED', 'SESSIONS_REVOKED_AFTER_PASSWORD_RESET', 'LOGIN_SUCCEEDED', 'LOGIN_FAILED', 'SESSION_CREATED', 'SESSION_REVOKED', 'REFRESH_TOKEN_ROTATED', 'REFRESH_TOKEN_REUSE_DETECTED', 'IDENTITY_SUSPENDED', 'SESSION_EXPIRED', 'NEW_DEVICE', 'SUSPICIOUS_LOGIN', 'CONCURRENT_LOGIN_LIMIT_REACHED', 'ADMINISTRATOR_SESSION_REVOKED', 'SECURITY_POLICY_VIOLATION');
